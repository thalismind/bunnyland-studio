...
cross-character data exposure, influence-claim or token compromise, secret disclosure,
remote code execution, or denial-of-service findings.

Include the affected version or immutable image digest, deployment shape, reproduction,
impact, and any evidence that can be shared safely. Remove bearer tokens, claim identifiers,
